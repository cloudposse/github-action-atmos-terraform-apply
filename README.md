...
> [!WARNING]
> **Deprecated.** Migrate to [Atmos Native CI](https://atmos.tools/deprecated/github-actions/atmos-terraform-apply).
...
https://atmos.tools/deprecated/github-actions/atmos-terraform-apply for the equivalent built-in
command (`atmos terraform apply` / `atmos terraform deploy`) and how to move your workflow over.
